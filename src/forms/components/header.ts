...
export const Header = async (): Promise<TextBox> => {
    ...
    textBox.addContent(centerContent(`\nBy Permasoft's Factory - ${addColor(link('official repo', 'https://github.com/permasoft-factory/youtube-downloader'), 'gray.underline')} >- v1.0.0`));
